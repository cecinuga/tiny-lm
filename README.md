...
### 0. Add automapper for argument parser
### 0. Improve saving checkpoint: check duplicate file name
### 1. Improve saving loss_log: check duplicate file name

### 1. Add disable checkpoint saving flag
### 2. Add disable mid-checkpoint saving flag

### 2. Add TrainConfig class in train.py and insert variable used by training

### 3. Add error handling in train.py

### 4. Improove overfitting detection system
